...
public class TopTest extends CalloutVerificationTest {
	...
	protected List<CalloutInitialValues> getExpectedCalls() {
		return List.of(
				...
				call(906089, "Out", "Out"),
				call(908137, "Stay Out", "Stay Out"),
				call(910184, "Corners", "Corners"),
				call(912186, "Sides", "Sides"),
				call(913256, "Party Stack", "Party Stack (5.3)"),
				call(914190, "In", "In"),
				call(932212, "Exaflares", "Exaflares (4.7)"),
				call(933902, "Bait Middle, Then East, Rotate Clockwise"),
				...
				call(982909, "In", "In"),
				call(984911, "Stay In", "Stay In"),
				call(987005, "Corners", "Corners"),
				call(989013, "Stay Out", "Stay Out"),
				call(989056, "Spread", "Spread"),
				call(991019, "Sides", "Sides"),
				...
				call(1010368, "Bait Middle, Then North, Rotate Clockwise"),
	...
	protected List<AmVerificationValues> getExpectedAms() {
		return List.of(
				...
				mark(773205, ATTACK1, MNK),
				mark(773205, ATTACK2, DRG),
				mark(773205, ATTACK3, GNB),
				mark(773205, ATTACK4, DNC),
				mark(773205, BIND1, SMN),
				mark(773205, BIND2, SGE),
				clearAll(785325)
		);
	}
}
