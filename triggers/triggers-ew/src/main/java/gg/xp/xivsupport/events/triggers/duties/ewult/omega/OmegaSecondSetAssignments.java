...
public class OmegaSecondSetAssignments extends BaseEvent {
	...
	public OmegaSecondSetAssignments(XivPlayerCharacter near, XivPlayerCharacter dist, List<XivPlayerCharacter> playersToMark, List<XivPlayerCharacter> leftovers) {
		super();
		this.near = near;
		this.dist = dist;
