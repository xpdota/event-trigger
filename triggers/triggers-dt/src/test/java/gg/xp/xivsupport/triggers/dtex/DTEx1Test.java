...
public class DTEx1Test extends CalloutVerificationTest {
	...
	protected List<CalloutInitialValues> getExpectedCalls() {
		return List.of(
				...
				call(35846, "Raidwide with Bleed", "Raidwide with Bleed (5.7)"),
				call(56842, "West Safe", "West Safe"),
				callAppend(70077, "Middle and Partners", "(7.0)"),
				call(75864, "Move Soon", "Move Soon (10.0)"),
				...
				call(242831, "Multiple Raidwides", "Multiple Raidwides (6.7)"),
				...
				call(434225, "Raidwide with Bleed", "Raidwide with Bleed (11.7)"),
