...
public class DsrTest extends CalloutVerificationTest {
	...
	protected List<CalloutInitialValues> getExpectedCalls() {
		return List.of(
				// Doorboss
				call(5974, "Raidwide", "Raidwide (3.7)"),
				call(18107, "In", "In (4.7)"),
				call(23144, "Stack on DRG Player", "Stack on DRG Player (4.7)"),
				call(38465, "Second Set", "Second Set"),
				call(56776, "Raidwide", "Raidwide (3.7)"),
				call(71807, "Interrupt Ser Adelphel", "Interrupt Ser Adelphel (3.7)"),
				call(80724, "Purple Square with DRG Player", "Purple Square with DRG Player"),
				call(90082, "Interrupt Ser Adelphel", "Interrupt Ser Adelphel (3.7)"),
				call(98009, "Raidwide", "Raidwide (3.7)"),
				call(99035, "In", "In (4.7)"),
				call(109052, "Interrupt Ser Adelphel", "Interrupt Ser Adelphel (3.7)"),
				call(148479, "Puddle on you", "Puddle on you (5.0)"),
				call(153468, "Move", "Move"),
				call(167236, "Cleave Bait", "Cleave Bait (2.7)"),
				// P2
				call(9230, "Cleave Bait", "Cleave Bait (2.7)"),
				call(36609, "East/West Safe", "East West Safe"),
				...
				call(105561, "Counterclockwise", "Counterclockwise"),
				call(106270, "Look away", "Look away (3.7)"),
				...
				call(174441, "Back then Left", "Back then Left (2.7)"),
				call(182895, "Back then Left", "Back then Left (2.7)"),
				// P3
				...
				call(252851, "In", "In"),
				call(256542, "Out", "Out"),
				call(268168, "Out of front", "Out of front (2.6)"),
				call(278175, "Bait Geirskogul", "Bait Geirskogul"),
				call(306278, "Out of front", "Out of front (2.6)"),
				// Eyes
				call(350014, "Red", "Red"),
				...
				call(529071, "Spread", "Spread (3.0)"),
				call(535247, "In with Lightning", "In with Lightning (4.7)"),
				call(541312, "Raidwide", "Raidwide (5.7)"),
				call(553717, "Buster on DRK Player, then 3 hits", "Buster on DRK Player, then 3 hits (3.7)"),
				call(583327, "Puddle", "Puddle"),
				call(592204, "Twister", "Twister"),
				call(600279, "Blue Cross", "Blue Cross"),
				call(600368, "Look away", "Look away (3.7)"),
				call(623248, "Raidwide", "Raidwide (5.7)"),
				call(635432, "Buster on DRK Player, then 3 hits", "Buster on DRK Player, then 3 hits (3.7)"),
				// P6
