...
public class AbilityEffectAndIndexRenderer implements TableCellRenderer {
	...
	private final AbilityHitIndexIndicator hitIndexIndicator = new AbilityHitIndexIndicator();
	{
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		if (value instanceof HasTargetIndex || value instanceof HasEffects) {
			...
			if (value instanceof HasTargetIndex hti && hti.getNumberOfTargets() > 1) {
