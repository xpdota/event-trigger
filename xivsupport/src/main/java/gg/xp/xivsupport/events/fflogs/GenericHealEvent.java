...
public class GenericHealEvent extends BaseEvent implements HasSourceEntity, HasTargetEntity, HasAbility, HasEffects {
	...
	public List<AbilityEffect> getEffects() {
		return Collections.singletonList(new HealEffect(0, 0, severity, amount));
	}
