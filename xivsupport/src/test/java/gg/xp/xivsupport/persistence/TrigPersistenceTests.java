...
public class TrigPersistenceTests {
	...
	public void testDefaultPropsLocation() throws InterruptedException {
		testPersistenceWrite(UserDirPropsPersistenceProvider.inUserDataFolder("integration-test"));
		// Wait for file flush
		Thread.sleep(200);
		testPersistenceRead(UserDirPropsPersistenceProvider.inUserDataFolder("integration-test"));
	}
