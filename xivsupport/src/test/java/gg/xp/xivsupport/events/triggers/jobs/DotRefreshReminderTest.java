...
public class DotRefreshReminderTest {
	...
	private static final XivPlayerCharacter thePlayer = new XivPlayerCharacter(0x123L, "Player", Job.WHM, new XivWorld(), true, 1, null, null, null, 0, 0, 0, 0, 0);
	private static final XivPlayerCharacter otherPlayer = new XivPlayerCharacter(0x222L, "Other", Job.WHM, new XivWorld(), false, 1, null, null, null, 0, 0, 0, 0, 0);
