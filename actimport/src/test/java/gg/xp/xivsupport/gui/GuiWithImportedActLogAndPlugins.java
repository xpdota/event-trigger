...
public final class GuiWithImportedActLogAndPlugins {
	private static final Logger log = LoggerFactory.getLogger(GuiWithImportedActLogAndPlugins.class);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<ACTLogLineEvent> events = EventReader.readEventsFromActLog("/uwu.log");
